...
const twoFactorAuthenticateUserUseCase: TwoFactorAuthenticateUserUseCase =
  new TwoFactorAuthenticateUserUseCase(
    postgresUsersRepository,
    JWTTokenProviderP,
  );

const twoFactorAuthenticateUserController: TwoFactorAuthenticateUserController =
  new TwoFactorAuthenticateUserController(twoFactorAuthenticateUserUseCase);
